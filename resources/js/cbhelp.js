...
new Array (".*hei\u00dft du.*","Mein Name ist Alice.","Alice","Alice, einen Nachnamen besitze ich nicht.","Ich bin Alice","Sag einfach Alice zu mir."),
  new Array ("Ich brauche (.*)\." , "Warum brauchst du $1?", "W\u00fclrde es dir wirklich helfe, wenn du $1 bekommst?" , "Bist du sicher, dass du $1 brauchst?"),
  new Array ("Bist du (.*?)[\?]","Was tut das zur Sache, ob ich $1 bin?","W\u00fcrdest du es besser finden, wenn ich nicht $1 w&aumlre?","Sch&oumln, dass du denkst ich w&aumlre $1.","Ja, vielleicht bin ich $1. Was denkst du?"),
  new Array ("Was (.*?)[\?]",	"Warum fragst du?","Da kann ich dir leider nicht weiter helfen.","Was denkst du?"),
  new Array ("Weil (.*)\.","Ist das der einzige Grund?", "Gibt es noch andere Gr\u00fclnde?"),
  new Array ("Ich denke (.*)\.","Zweifelst du daran?","Denkst du wirklich?","Aber du bist nicht sicher?"),
  new Array ("(.*) Freund(.*)\.",	"Erz&aumlhl mir mehr \u00fclber deine Freunde.","Wenn du an einen Freund denkst, was kommt dir als erstes in den Sinn?","Hast du noch mehr Freunde?","Willst du mein Freund sein?"),
  new Array ("(Ja\.|Ja)","Du wirkst sehr sicher.","OK, wenn du das sagst.","Das habe ich mir schon gedacht.","Ich wusste, dass du das sagst."),
  new Array ("(Nein\.|Nein)","Du wirkst sehr sicher.","OK, wenn du meinst","Das habe ich schon vermutet.","Das \u00fclberrascht mich jetzt."),
  ...
  new Array ("(.*) Computer(.*)\.","Redest du etwa \u00fclber mich?","Ist es ungew&oumlhnlich mit einem Computer zu reden?","Hast du Angst vor k&uumlnstlichen Intelligenzen?"),
  ...
  new Array ("Kann ich (.*?)[\?]","Vielleicht willst du das ja garnicht.","Ich wei\u00df nicht ob du das kannst.","Wenn du das k&oumlnntest, w&uumlrdest du es tun?"),
