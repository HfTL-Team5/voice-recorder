  ...
  new Array ("(.*) (Hilfe|helfen)(.*)\.","Ich kann leider nicht alles wissen, aber schreibe uns doch eine EMail: team_5@outlook.de.","Manchmal bin ich einfach überfragt. Du erreichst uns unter team_5@outlook.de.","Kannst du mir dein Problem beschreiben?","Wie kann ich dir helfen?"),
  new Array ("(Hilfe|helfen)","Ich kann leider nicht alles wissen, aber schreibe uns doch eine EMail: team_5@outlook.de.","Manchmal bin ich einfach überfragt. Du erreichst uns unter: team_5@outlook.de.","Kannst du mir dein Problem beschreiben?","Wie kann ich dir helfen?"),
  ...
  new Array (".*(Text).*","Der Befehl hierfür lautet >Text<. Sie können den eigegebenen Text auch jederzeit manuell bearbeiten. Per Sprachbefehl ist dies leider nicht möglich. Desweiteren haben Sie die Möglichkeit bei der Eingabe eines Neuen Textes zu wählen, ob dieser fett, kursiv oder unterstrichen sein soll. Dazu erscheint ein Menü auf der linken Seite."),
	  ...
	  new Array (".*(Download|export|speichern).*","Durch das Wort >Download<, können Sie die Datei als MS Word zwischenspeichern."),
...
new Array (".*dein name.*","Mein Name ist Mia.","Mia","Mia, einen Nachnamen besitze ich nicht.","Ich bin Mia","Sag einfach Mia zu mir."),
new Array (".*heißt du.*","Mein Name ist Mia.","Mia","Mia, einen Nachnamen besitze ich nicht.","Ich bin Mia","Sag einfach Mia zu mir."),
  ...
  new Array (".*(Chatbot).*","Ich bin ein Chatbot.","Chatterbots, Chatbots oder kurz Bots sind textbasierte Dialogsysteme.","Hast du Angst vor künstlichen Intelligenzen?"),
  ...
  new Array (".*(Danke).*","Bitte.","Nichts zu danken.","Habe ich gern gemacht."),
